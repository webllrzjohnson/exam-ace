...
import { FileQuestion, MessageSquare, Plus } from "lucide-react";
    ...
    <div className="container py-10">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            <h2 className="font-display font-bold text-foreground">Manage Testimonials</h2>
            <p className="text-sm text-muted-foreground">Approve or reject pending testimonials</p>
          </div>
          <Plus className="w-5 h-5 ml-auto text-muted-foreground" />
        </Link>
      </div>
